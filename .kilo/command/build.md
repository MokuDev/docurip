...
Use the `incremental-implementation` skill alongside the `test-driven-development` skill.
...
3. **Plan if needed.** If there is no `tasks/plan.md`, use the `planning-and-task-breakdown` skill to generate one.
